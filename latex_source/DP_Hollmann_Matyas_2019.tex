...
$$
\end{DF}
\noindent The algorithm itself is presented in chapter \ref{divAlg}. Unfortunately,  the remainder is not uniquely characterised and depends on the order of the divisors in the set $F$, and also on the monomial order itself. \\ \\
