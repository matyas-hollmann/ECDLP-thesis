...
\bibitem{secTest}{GUPTA, Kamlesh a Sanjay SILAKARI. ECC over RSA for Asymmetric Encryption: A Review. International Journal of Computer Science Issues. 2011, 8(05). Also available at: \url{https://pdfs.semanticscholar.org/45ef/c85c2a92fe00dae5477f918795d9fd23e6e5.pdf}.}
...
\bibitem{macal}{JÓNSSON, Gudbjörn F. and Stephen A. VAVASIS. \textit{ACCURATE SOLUTION OF POLYNOMIAL EQUATIONS USING MACAULAY RESULTANT MATRICES}. MATHEMATICS OF COMPUTATION. 2004, 74(249), 221-262.
...
The Sage Development Team, 2019. Accessed on [01-05-2019]. Available at: \url{http://www.sagemath.org/}.}
...
\bibitem{fgb}{FAUG\`{E}RE, J.-C., \textit{FGb: A Library for Computing Gröbner Bases. Version 1.68 (build 14539).} Updated on 31.07.2015. Accessed on [10-04-2019]. Available at: \url{https://www-polsys.lip6.fr/~jcf/FGb/index.html}.}

\bibitem{giac}{PARISSE, Bernard and Renée De GRAEVE, \textit{Giac/Xcas (Version 1.5.0-3)}. Updated in September 2018. Accessed on [15-04-2019]. Available at: \url{https://www-fourier.ujf-grenoble.fr/~parisse/giac.html}.}
